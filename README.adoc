...
[NOTE]
====
image:https://img.shields.io/badge/last_updated-2025.04.16-blue[]
...
image::https://img.youtube.com/vi/72kGl2pRWA8/sddefault.jpg[Latest video recording,800,link=https://www.youtube.com/watch?v=72kGl2pRWA8,title="OpenTelemetry Tracing – Practical Intro for Java & Microservices | Nicolas Fränkel @ LJC x Couchbase"]