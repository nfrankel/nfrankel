...
https://geekle.us/kotlin[Designing a DSL with Kotlin^] @ https://geekle.us/kotlin[Kotlin Global Summit^]::
+
...
https://2021.eventsourcing.live/speakers/nicolas-frankel[A Change-Data-Capture use-case: designing an evergreen cache^] @ https://eventsourcing.live/[EventSourcing Live^]::
+
