...
[NOTE]
====
image:https://img.shields.io/badge/last_updated-2025.05.12-blue[]
...
https://jprime.io/agenda/221[Practical introduction to OpenTelemetry tracing^] @ https://jprime.io/[jPrime^]::
+
